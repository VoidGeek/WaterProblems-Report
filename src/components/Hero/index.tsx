            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                <h1 className="mb-5 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                  Revolutionize Water Management with Hydro
                  <span className="text-primary">H</span>ub's Dynamic Technology
                </h1>
                <p className="mb-12 text-base !leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                  HydroHub is a ground breaking mobile application designed to
                  revolutionize community-driven water management by leveraging
                  crowdsourcing, open data integration, and dynamic mapping
                  technologies.
                </p>
